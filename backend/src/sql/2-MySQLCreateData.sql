...
INSERT INTO Part (reference, name, amount, price, photo_url, description, last_purchase_price, provider) VALUES ('Reference 1', 'Name 1', 5, 1.1, 'Photo url 1', 'Description 1', 1.1, 'Provider 1');